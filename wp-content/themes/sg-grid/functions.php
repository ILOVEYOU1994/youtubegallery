...
function sggrid_defaults( $defaults ) {
	...
	$defaults['footer_text'] = '<a href="' . 'http://wordpress.org/' . '">' . __( 'Powered by WordPress', 'sg-grid' ). '</a> | ' . __( 'theme ', 'sg-grid' ) . '<a href="' . 'https://visualpharm.com/wpblogs/themes/blog/theme/sg-grid/' . '">SG Grid</a>';
